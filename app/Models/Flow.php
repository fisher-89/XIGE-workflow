...
{
    use SoftDeletes;
    protected $fillable = ['name', 'description', 'flow_type_id', 'form_id', 'sort','number', 'is_active', 'start_callback_uri','accept_start_callback', 'end_callback_uri','accept_end_callback','send_message'];
