...
class StepRun extends Model
{
    ...
    protected $fillable = ['step_id', 'step_key','step_name','flow_type_id', 'flow_id', 'flow_name', 'flow_run_id', 'form_id', 'data_id', 'approver_sn', 'approver_name', 'checked_at', 'action_type', 'acted_at', 'remark'];
